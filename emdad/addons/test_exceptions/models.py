...
import emdad.exceptions
from emdad import models, api
...
class m(models.Model):
    ...
    def generate_redirect_warning(self):
        ...
        raise emdad.exceptions.RedirectWarning('description', action.id, 'Go to the redirection')

    def generate_access_denied(self):
        raise emdad.exceptions.AccessDenied()

    def generate_access_error(self):
        raise emdad.exceptions.AccessError('description')
    ...
    def generate_user_error(self):
        raise emdad.exceptions.UserError('description')

    def generate_missing_error(self):
        raise emdad.exceptions.MissingError('description')

    def generate_validation_error(self):
        raise emdad.exceptions.ValidationError('description')
