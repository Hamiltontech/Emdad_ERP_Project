...
from emdad.tools.float_utils import float_round
_logger = logging.getLogger('precompute_setter')

from emdad import models, fields, api, _, Command
from emdad.exceptions import AccessError, ValidationError
from emdad.tools.translate import html_translate
