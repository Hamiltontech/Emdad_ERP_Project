...
import emdad
from emdad import api, http
from emdad.addons import __path__ as ADDONS_PATH
from emdad.addons.base.models.assetsbundle import AssetsBundle, ANY_UNIQUE
from emdad.addons.base.models.ir_asset import AssetPaths
from emdad.addons.base.models.ir_attachment import IrAttachment
from emdad.modules.module import get_manifest
from emdad.tests import HttpCase, tagged
from emdad.tests.common import TransactionCase
from emdad.addons.base.models.ir_qweb import QWebException
from emdad.tools import mute_logger, func
...
class TestAddonPaths(TransactionCase):
    def test_operations(self):
        ...
        asset_paths.append([
            ('/home/user/emdad/addons/web/a', '/web/a', 1),
            ('/home/user/emdad/addons/web/c', '/web/c', 1),
            ('/home/user/emdad/addons/web/d', '/web/d', 1),
        ], 'bundle1')
        self.assertEqual(asset_paths.list, [
            ('/home/user/emdad/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/emdad/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/emdad/addons/web/d', '/web/d', 'bundle1', 1),
        ])

        # append with a duplicate of 'c'
        asset_paths.append([
            ('/home/user/emdad/addons/web/c', '/web/c', 1),
            ('/home/user/emdad/addons/web/f', '/web/f', 1),
        ], 'bundle2')
        self.assertEqual(asset_paths.list, [
            ('/home/user/emdad/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/emdad/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/emdad/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/emdad/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'c' after 'c'
        asset_paths.insert([
            ('/home/user/emdad/addons/web/c', '/web/c', 1),
            ('/home/user/emdad/addons/web/e', '/web/e', 1),
        ], 'bundle3', 3)
        self.assertEqual(asset_paths.list, [
            ('/home/user/emdad/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/emdad/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/emdad/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/emdad/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/emdad/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'd' before 'd'
        asset_paths.insert([
            ('/home/user/emdad/addons/web/b', '/web/b', 1),
            ('/home/user/emdad/addons/web/d', '/web/d', 1),
        ], 'bundle4', 1)
        self.assertEqual(asset_paths.list, [

            ('/home/user/emdad/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/emdad/addons/web/b', '/web/b', 'bundle4', 1),
            ('/home/user/emdad/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/emdad/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/emdad/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/emdad/addons/web/f', '/web/f', 'bundle2', 1),
        ...
        asset_paths.remove([
            ('/home/user/emdad/addons/web/c', '/web/c', 1),
            ('/home/user/emdad/addons/web/d', '/web/d', 1),
            ('/home/user/emdad/addons/web/g', '/web/g', 1),
        ], 'bundle5')
        self.assertEqual(asset_paths.list, [
            ('/home/user/emdad/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/emdad/addons/web/b', '/web/b', 'bundle4', 1),
...
class AddonManifestPatched(TransactionCase):
    def setUp(self):
        ...
        self.patch(emdad.modules.module, '_get_manifest_cached', Mock(side_effect=lambda module: self.manifests.get(module, {})))
...
<html>
    <head>
        ...
        <script type="text/javascript" src="{links[5]}" onerror="__emdadAssetError=1"></script>
    </head>
    <body>
    </body>
</html>"""))
...
<html>
    <head>
        ...
        <script type="text/javascript" src="http://test.external.link/javascript1.js"></script>
        <script type="text/javascript" src="http://test.external.link/javascript2.js"></script>
        <script type="text/javascript" src="/web/assets/debug/test_assetsbundle.bundle4.js" onerror="__emdadAssetError=1"></script>
    </head>
    <body>
    </body>
</html>"""))
...
class TestAssetsManifest(AddonManifestPatched):
    ...
    @mute_logger('emdad.addons.base.models.ir_asset')
    def test_31(self):
...
class TestErrorManagement(HttpCase):
    ...
    def test_assets_bundle_css_error_backend(self):
        ...
        with mute_logger('emdad.addons.base.models.assetsbundle'):
