...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - emdad/addons/test_access_rights/tests/test_feedback.py
        # - emdad/addons/test_access_rights/tests/test_ir_rules.py
        # - emdad/addons/base/tests/test_orm.py (/home/dle/src/emdad/master-nochange-fp/emdad/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.env.registry.clear_cache()
        return res
    ...
    def _make_access_error(self, operation, records):
        ...
        if company_related:
            failing_rules += "\n\n" + _('Note: this might be a multi-company issue. Switching company may help - in emdad, not in real life!')
