...
import emdad
from emdad import api, http, models, tools, SUPERUSER_ID
from emdad.exceptions import AccessDenied, AccessError, MissingError
from emdad.http import request, Response, ROUTING_KEYS, Stream
from emdad.modules.registry import Registry
from emdad.service import security
from emdad.tools import get_lang, submap
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (emdad.exceptions.AccessError, emdad.exceptions.MissingError) as e:
                ...
                if isinstance(e, emdad.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(emdad.conf.server_wide_modules)
        if tools.config['test_enable'] and emdad.modules.module.current_test:
            installed.add(emdad.modules.module.current_test)
