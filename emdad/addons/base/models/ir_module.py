...
import emdad
from emdad import api, fields, models, modules, tools, _
...
from emdad.tools.misc import topological_sort, get_flag
from emdad.tools.translate import TranslationImporter, get_po_paths
from emdad.http import request
from emdad.modules import get_module_path
...
class Module(models.Model):
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since emdad 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since emdad 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'emdad Enterprise Edition License v1.0'),
        ('OPL-1', 'emdad Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('emdad Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("emdad is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(emdad.conf.server_wide_modules) & set(self.mapped('name'))
