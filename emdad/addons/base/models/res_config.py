...
from emdad.exceptions import AccessError, RedirectWarning, UserError
from emdad.tools import ustr
...
class ResConfigSettings(models.TransientModel, ResConfigModuleInstallationMixin):
    ...
    def get_config_warning(self, msg):
        ...
        Example of use:
        ---------------
        from emdad.addons.base.models.res_config import get_warning_config
