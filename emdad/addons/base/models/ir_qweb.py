...
QWeb is the primary templating engine used by emdad. It is an XML templating
...
<https://www.emdad.com/documentation/17.0/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed emdad user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``user_has_groups`` emdad method.
...
from emdad import api, models, tools
from emdad.modules import registry
from emdad.tools import config, safe_eval, pycompat
from emdad.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from emdad.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from emdad.tools.json import scriptsafe
from emdad.tools.lru import LRU
from emdad.tools.misc import str2bool
from emdad.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from emdad.http import request
from emdad.tools.profiler import QwebTracker
from emdad.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from emdad.addons.base.models.assetsbundle import AssetsBundle
from emdad.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since emdad 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__emdadAssetError=1"
