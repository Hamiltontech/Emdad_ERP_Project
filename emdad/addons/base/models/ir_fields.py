...
from emdad import api, Command, fields, models, _
from emdad.tools import ustr, OrderedSet
from emdad.tools.translate import code_translations, _lt
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an emdad
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`emdad.osv.orm.Model.write` expects.

        :param model: :class:`emdad.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`emdad.fields.Field`
