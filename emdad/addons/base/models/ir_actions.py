...
import emdad
from emdad import api, fields, models, tools, _, Command
from emdad.exceptions import MissingError, ValidationError, AccessError, UserError
from emdad.tools import frozendict
from emdad.tools.safe_eval import safe_eval, test_python_expr
from emdad.tools.float_utils import float_compare
...
class IrActionsServer(models.Model):
    ...
    Since emdad 8.0 a button 'Create Menu Action' button is available on the
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'UserError': emdad.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
