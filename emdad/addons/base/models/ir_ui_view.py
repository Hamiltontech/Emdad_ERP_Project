...
import emdad
from emdad import api, fields, models, tools, _
from emdad.exceptions import ValidationError, AccessError, UserError
from emdad.http import request
from emdad.modules.module import get_resource_from_path
from emdad.tools import config, ConstantMapping, get_diff, pycompat, apply_inheritance_specs, locate_node, str2bool
from emdad.tools import safe_eval, lazy, lazy_property, frozendict
from emdad.tools.convert import _fix_multiple_roots
from emdad.tools.misc import file_path
from emdad.tools.translate import xml_translate, TRANSLATED_ATTRS
from emdad.tools.view_validation import valid_view, get_domain_value_names, get_expression_field_names, get_dict_asts
from emdad.models import check_method_name
from emdad.osv.expression import expression
...
@lazy
def keep_query():
    mod = emdad.addons.base.models.ir_qweb
