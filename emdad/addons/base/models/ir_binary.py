...
from emdad.exceptions import MissingError, UserError
from emdad.http import Stream, request
from emdad.tools import file_open, replace_exceptions
from emdad.tools.image import image_process, image_guess_size_from_field_name
from emdad.tools.mimetypes import guess_mimetype, get_extension
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:emdad.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~emdad.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`emdad.tools.image.image_process`.
