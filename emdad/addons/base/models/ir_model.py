...
from emdad import api, fields, models, tools, _, _lt, Command
from emdad.exceptions import AccessError, UserError, ValidationError
from emdad.osv import expression
from emdad.tools import pycompat, unique, OrderedSet
from emdad.tools.safe_eval import safe_eval, datetime, dateutil, time
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in emdad.modules.loading.
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by emdad
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement emdad many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by emdad
