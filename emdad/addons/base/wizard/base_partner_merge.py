...
from emdad import api, fields, models, Command
from emdad import SUPERUSER_ID, _
from emdad.exceptions import ValidationError, UserError
from emdad.tools import mute_logger

_logger = logging.getLogger('emdad.addons.base.partner.merge')
    ...
    def _update_foreign_keys(self, src_partners, dst_partner):
        ...
        for table, column in relations:
            ...
            if len(columns) <= 1:
                ...
                try:
                    with mute_logger('emdad.sql_db'), self._cr.savepoint():
