...
from emdad.tests import TransactionCase, tagged, Form


@tagged('-at_install', 'post_install')
class TestFormCreate(TransactionCase):
    """
    Test that the basic emdad models records can be created on
    the interface.
    """
    ...
    def test_create_res_partner(self):
        ...
        if hasattr(self.env['res.partner'], 'property_account_payable_id'):
            ...
            # https://github.com/emdad/enterprise/blob/bfa643278028da0bfabded2f87ccb7e323d697c1/account_accountant/views/product_views.xml#L9
