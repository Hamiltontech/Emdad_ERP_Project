...
from emdad.tests import BaseCase, tagged
...
class TestRetryCommon(BaseCase):
    def get_tests_run_count(self):
        return int(os.environ.get('emdad_TEST_FAILURE_RETRIES', 0)) + 1
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when emdad_TEST_FAILURE_RETRIES is set"""
