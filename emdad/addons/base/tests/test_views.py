...
from emdad.exceptions import AccessError, ValidationError
from emdad.tests import common, tagged
from emdad.addons.base.tests.common import TransactionCaseWithUserDemo
from emdad.tools import get_cache_key_counter, mute_logger, view_validation, safe_eval
from emdad.addons.base.models import ir_ui_view
...
class ViewCase(TransactionCaseWithUserDemo):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view', inherit_id=False):
        with mute_logger('emdad.addons.base.models.ir_ui_view'):
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view'):
        with self.assertLogs('emdad.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
