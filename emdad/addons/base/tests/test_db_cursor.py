...
import emdad
from emdad.sql_db import db_connect, TestCursor
from emdad.tests import common
from emdad.tests.common import BaseCase
from emdad.tools.misc import config

ADMIN_USER_ID = common.ADMIN_USER_ID

def registry():
    return emdad.registry(common.get_db_name())
...
class TestTestCursor(common.TransactionCase):
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('emdad.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:emdad.sql_db:Found different un-closed cursor', msg)
