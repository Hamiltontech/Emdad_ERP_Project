...
from emdad.addons.base.tests.common import SavepointCaseWithUserDemo
from emdad.fields import Date
from emdad.models import BaseModel
from emdad.tests.common import BaseCase, TransactionCase
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('emdad.osv.expression'):
    ...
    def test_accent(self):
        ...
        with patch('emdad.osv.expression.get_unaccent_wrapper') as w:
    ...
    def test_like_cast(self):
        ...
        with mute_logger('emdad.sql_db'), self.assertRaises(psycopg2.Error):
