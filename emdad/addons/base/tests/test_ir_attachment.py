...
from emdad.tools import image_to_base64
...
class TestIrAttachment(TransactionCaseWithUserDemo):
    ...
    def test_10_image_autoresize(self):
        ...
        with Image.open(os.path.join(dir_path, 'emdad.jpg'), 'r') as logo:
    ...
    def test_13_rollback(self):
        ...
        self.env = emdad.api.Environment(self.cr, emdad.SUPERUSER_ID, {})
...
class TestPermissions(TransactionCaseWithUserDemo):
    ...
    def test_read_permission(self):
        ...
        attachment_admin = self.Attachments.with_user(emdad.SUPERUSER_ID).create({'name': 'foo'})
        ...
        self.assertNotEqual(emdad.SUPERUSER_ID, admin_user.id)
