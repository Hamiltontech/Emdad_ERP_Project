...
import emdad
from emdad import api, fields
from emdad.tests.common import BaseCase, TransactionCase, RecordCapturer, get_db_name, tagged
...
class TestIrCronConcurrent(BaseCase, CronMixinCase):
    ...
    def setUp(self):
        ...
        with self.registry.cursor() as cr:
            env = api.Environment(cr, emdad.SUPERUSER_ID, {})
