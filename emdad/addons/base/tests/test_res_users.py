...
from emdad.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from emdad.exceptions import UserError
from emdad.tests.common import Form, TransactionCase, new_test_user, tagged
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('emdad.sql_db', 'emdad.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('emdad.addons.base.models.res_users.request', request)
