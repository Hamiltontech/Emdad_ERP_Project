...
from emdad.modules import get_modules, get_module_path
...
class TestPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        options = [
            ...
            '--load-plugins=pylint.extensions.bad_builtin,_emdad_checker_sql_injection,_emdad_checker_gettext,_emdad_checker_unlink_override',
