...
from emdad.modules.module import _DEFAULT_MANIFEST, module_manifest, get_module_path
from emdad.tests import BaseCase
...
class ManifestLinter(BaseCase):
    ...
    def _load_manifest(self, module):
        """Do not rely on emdad/modules/module -> load_manifest
