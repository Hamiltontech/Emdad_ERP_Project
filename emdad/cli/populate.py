        ...
        try:
            ...
            for model in ordered_models:
                if profiling_enabled:
                    profiling_context = emdad.tools.profiler.Profiler(
                ...
                if commit:
                    ...
                    commit_context = patch('emdad.sql_db.Cursor.commit')
