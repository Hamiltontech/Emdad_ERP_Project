...
from emdad.modules.module import get_module_root, MANIFEST_NAMES
from emdad.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """ Quickly start the emdad server with default options """
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            emdad.tools.config['init']['base'] = True
