...
import emdad
from emdad.loglevels import ustr
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~emdad.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within emdad, this assumption is certain to fall short for international
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@emdad.com
    * Output: "Admin" <notifications@emdad.com>
    """
