...
product_name = 'emdad'
description = 'emdad Server'
long_desc = '''emdad is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'OpenERP S.A.'
author_email = 'info@emdad.com'
license = 'LGPL-3'

nt_service_name = "emdad-server-" + series.replace('~','-')
