...
"""The emdad API module defines emdad Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~emdad.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~emdad.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/emdad/emdad/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~emdad.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~emdad.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~emdad.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~emdad.addons.base.models.res_company.Company>`
