...
from emdad.addons.base.models.ir_mail_server import IrMailServer
from emdad.addons.base.tests.common import MockSmtplibCase
from emdad.addons.bus.models.bus import ImBus, json_dump
from emdad.addons.mail.models.mail_mail import MailMail
from emdad.addons.mail.models.mail_message import Message
from emdad.addons.mail.models.mail_notification import MailNotification
from emdad.addons.mail.models.res_users import Users
from emdad.tests import common, new_test_user
from emdad.tools import email_normalize, formataddr, mute_logger, pycompat
from emdad.tools.translate import code_translations
...
class MailCommon(common.TransactionCase, MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("emdad.addons.base.models.ir_module", "emdad.tools.translate"):
