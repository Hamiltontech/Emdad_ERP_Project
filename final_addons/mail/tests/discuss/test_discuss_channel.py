...
from emdad import Command, fields
from emdad.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
from emdad.addons.mail.tests.common import mail_new_test_user
...
from emdad.tools import html_escape, mute_logger
from emdad.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class TestChannelInternals(MailCommon):
    ...
    @users('employee')
    @mute_logger('emdad.addons.mail.models.mail_mail', 'emdad.models.unlink')
