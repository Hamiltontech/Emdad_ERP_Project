...
from emdad.addons.mail.models.mail_activity import MailActivity
from emdad.addons.mail.tests.common import MailCommon
from emdad.tests.common import Form, tagged, HttpCase
from emdad.tools.misc import format_date
