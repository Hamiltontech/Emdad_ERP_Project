...
Communicate with your colleagues/customers/guest within emdad.
...
from emdad itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your emdad system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled emdad documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-emdad integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within emdad, and the
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'mail/static/lib/**/*',
            ('remove', 'mail/static/lib/emdad_sfu/emdad_sfu.js'),
        ...
        'mail.assets_emdad_sfu': [
            'mail/static/lib/emdad_sfu/emdad_sfu.js',
        ],
        'mail.assets_lamejs': [
        ...
        'mail.assets_public': [
            ...
            'web/static/lib/emdad_ui_icons/style.css',
