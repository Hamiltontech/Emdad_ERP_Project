...
export class Store extends BaseStore {
    ...
    menuThreads = Record.many("Thread", {
        ...
        sort(a, b) {
             ...
             */
            const aemdadBot = a.isCorrespondentemdadBot;
            const bemdadBot = b.isCorrespondentemdadBot;
            if (aemdadBot && !bemdadBot) {
                return 1;
            }
            if (bemdadBot && !aemdadBot) {
                return -1;
            }
