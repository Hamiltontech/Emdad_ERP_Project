...
import { reactive } from "@emdad/owl";
...
/**
 * @return {Promise<{ SfuClient: import("@mail/static/libs/emdad_sfu/emdad_sfu").SfuClient, SFU_CLIENT_STATE: import("@mail/static/libs/emdad_sfu/emdad_sfu").SFU_CLIENT_STATE }>}
 */
const loadSfuAssets = memoize(async () => await loadBundle("mail.assets_emdad_sfu"));
...
export class Rtc {
    ...
    /** @type {import("@mail/static/libs/emdad_sfu/emdad_sfu").SfuClient} */
    sfuClient = undefined;

    /**
     * @param {import("@web/env").emdadEnv} env
    ...
    async loadSfuClient() {
        ...
        try {
            await loadSfuAssets();
            const sfuModule = emdad.loader.modules.get("@mail/../lib/emdad_sfu/emdad_sfu");
