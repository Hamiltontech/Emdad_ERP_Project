...
from emdad.http import request, Response
from emdad import http, tools, _, SUPERUSER_ID, release
from emdad.addons.http_routing.models.ir_http import slug, unslug
from emdad.addons.web_editor.tools import get_video_url_data
from emdad.exceptions import UserError, MissingError, AccessError
from emdad.tools.misc import file_open
from emdad.tools.mimetypes import guess_mimetype
from emdad.tools.image import image_data_uri, binary_to_image
from emdad.addons.base.models.assetsbundle import AssetsBundle

from ..models.ir_attachment import SUPPORTED_IMAGE_MIMETYPES

logger = logging.getLogger(__name__)
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.emdad.com'
