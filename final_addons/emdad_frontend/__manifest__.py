...
#    Author: Raneesha M K (emdad@cybrosys.com)
#
...
###############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            'emdad_frontend/static/src/scss/education_backend.scss',
            'emdad_frontend/static/src/js/sidebar_menu.js',
            'emdad_frontend/static/src/xml/sidebar.xml'
        ],
    },
    'images': [
