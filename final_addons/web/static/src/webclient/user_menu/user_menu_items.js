...
import { Component, markup } from "@emdad/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.emdad.com/documentation/17.0";
    return {
        type: "item",
        id: "documentation",
...
function emdadAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My emdad.com account"),
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.open("https://accounts.emdad.com/account", "_blank");
                });
        },
        sequence: 60,
    };
...
registry
    ...
    // .add("emdad_account", emdadAccountItem)
