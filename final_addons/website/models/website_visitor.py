...
from emdad.addons.base.models.res_partner import _tz_get
from emdad.exceptions import UserError
from emdad.tools import split_every
from emdad.tools.misc import _format_time_ago
...
class WebsiteVisitor(models.Model):
    ...
    def _upsert_visitor(self, access_token, force_track_values=None):
        ...
        create_values = {
            ...
            # code which is unknown in emdad
