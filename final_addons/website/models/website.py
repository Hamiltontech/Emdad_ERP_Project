...
from emdad import api, fields, models, tools, http, release, registry
from emdad.addons.http_routing.models.ir_http import RequestUID, slugify, url_for
from emdad.addons.website.models.ir_http import sitemap_qs2dom
from emdad.addons.website.tools import similarity_score, text_from_html, get_base_domain
from emdad.addons.portal.controllers.portal import pager
from emdad.addons.iap.tools import iap_tools
from emdad.exceptions import AccessError, MissingError, UserError, ValidationError
from emdad.http import request
from emdad.modules.module import get_manifest
from emdad.osv.expression import AND, OR, FALSE_DOMAIN, get_unaccent_wrapper
from emdad.tools.translate import _, xml_translate
from emdad.tools import escape_psql, pycompat
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.emdad.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.emdad.com'
...
class Website(models.Model):
    ...
    def get_website_page_ids(self):
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the emdad framework works.
