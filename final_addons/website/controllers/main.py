...
from emdad import http, models, fields, _
from emdad.exceptions import AccessError
from emdad.http import request, SessionExpiredException
from emdad.osv import expression
from emdad.tools import OrderedSet, escape_psql, html_escape as escape
from emdad.addons.base.models.ir_qweb import QWebException
from emdad.addons.http_routing.models.ir_http import slug, slugify, _guess_mimetype
from emdad.addons.portal.controllers.portal import pager as portal_pager
from emdad.addons.portal.controllers.web import Home
from emdad.addons.web.controllers.binary import Binary
from emdad.addons.website.tools import get_base_domain
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': emdad.service.common.exp_version()
        }
