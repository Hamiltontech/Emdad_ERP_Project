...
from emdad import http, SUPERUSER_ID, _, _lt
from emdad.addons.base.models.ir_qweb_fields import nl2br, nl2br_enclose
from emdad.http import request
from emdad.tools import plaintext2html
from emdad.exceptions import AccessDenied, ValidationError, UserError
from emdad.tools.misc import hmac, consteq
