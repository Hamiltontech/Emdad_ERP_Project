...
from emdad.tests.common import TransactionCase, new_test_user
from emdad.exceptions import ValidationError
from emdad.tools import mute_logger
from emdad.service.model import retrying
from emdad.addons.website.tools import MockRequest
...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_same_website_message(self):
        ...
        with TestCase.assertRaises(self, ValidationError), mute_logger('emdad.sql_db'):
