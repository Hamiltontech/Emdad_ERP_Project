...
@emdad.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(emdad.tests.HttpCase):
...
@emdad.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(emdad.tests.HttpCase):
...
class TestUi(emdad.tests.HttpCase):
