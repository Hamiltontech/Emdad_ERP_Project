...
import { boundariesIn, setSelection } from '@web_editor/js/editor/emdad-editor/src/utils/utils';
...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL emdad.com",
    ...
    // 2. Edit the link with the link tools.
    {
        ...
        trigger: 'iframe .s_text_image a[href="http://emdad.com"]:contains("emdad.com")',
    },
    {
        content: "Change content (editing the label input) to emdad website_2",
        trigger: '#o_link_dialog_label_input:propValue(emdad.com)',
        run: 'text emdad website_2',
    },
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://emdad.com"]:contains("emdad website_2")',
    },
    {
        content: "Change content (editing the DOM) to emdad website",
        trigger: 'iframe .s_text_image a[href="http://emdad.com"]:contains("emdad website_2")',
        run: 'text emdad website',
    },
    clickOnImgStep,
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://emdad.com"]:contains("emdad website")',
    },
    {
        content: "Check that the label input contains the new content",
        trigger: '#o_link_dialog_label_input:propValue(emdad website)',
        isCheck: true,
    },
    {
        content: "Link tools, should be open, change the url",
        trigger: '#o_link_dialog_url_input',
        run: 'text_blur emdad.be'
    },
    ...
    {
        content: "The new link content should be emdad website and url emdad.be",
        trigger: 'iframe .s_text_image a[href="http://emdad.be"]:contains("emdad website")',
    },
    {
        content: "The new link content should be emdad website and url emdad.be",
    ...
    ...wTourUtils.clickOnSave(),
    {
        ...
        trigger: 'iframe .s_text_image a.btn.btn-secondary[href="http://emdad.be"]:contains("emdad website")',
        isCheck: true,
    },
    // 4. Add link on image.
    ...wTourUtils.clickOnEditAndWaitEditMode(),
    ...
    },
    {
        ...
        trigger: 'iframe .popover div a:contains("http://emdad.com")',
        isCheck: true,
    },
    // 5. Remove link from image.
    {
        content: "Remove link.",
        trigger: 'iframe .popover:contains("http://emdad.com") a .fa-chain-broken',
    },
    {
    ...
    wTourUtils.clickOnElement("card's text", "iframe header .s_mega_menu_cards p"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "text https://www.emdad.com",
    },
    {
        content: "Check nothing is lost",
        trigger: "iframe header .s_mega_menu_cards a[href='https://www.emdad.com']:has(img):has(h4):has(p)",
        isCheck: true,
    },
    ...
    {
        content: "Select text",
        trigger: 'iframe #wrap .s_text_image p:contains(emdad.com)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: "iframe .s_text_image p a[href='http://emdad.com']:contains('emdad.com')",
        isCheck: true,
    },
    {
    ...
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: 'text https://emdad.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='https://emdad.com']:contains('emdad.com')",
        isCheck: true,
    },
    {
        content: "Change it back http",
        trigger: "#o_link_dialog_url_input",
        run: 'text http://emdad.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='http://emdad.com']:contains('emdad.com')",
    ...
    // TODO this step which was added by https://github.com/emdad/emdad/commit/9fc283b514d420fdfd66123845d9ec3563572692
