...
const BaseAnimatedHeader = animations.Animation.extend({
    ...
    start: function () {
        ...
        // transitionstart, so we listen to a custom emdad event.
        this._transitionCount = 0;
        this.$el.on('emdad-transitionstart.BaseAnimatedHeader', () => {
    ...
    _adaptToHeaderChange: function () {
        this.options.wysiwyg && this.options.wysiwyg.emdadEditor.observerUnactive();
        ...
        this.options.wysiwyg && this.options.wysiwyg.emdadEditor.observerActive();
    },
    /**
     * @private
    ...
    _updateHeaderOnScroll: function (scroll) {
        ...
        if (this.headerIsScrolled !== headerIsScrolled) {
            ...
            if (!this.scrollHeightTooShort) {
                ...
                this.$el.trigger('emdad-transitionstart');
...
publicWidget.registry.MegaMenuDropdown = publicWidget.Widget.extend({
    ...
    _moveMegaMenu(megaMenuToggleEl) {
        ...
        this.options.wysiwyg?.emdadEditor.observerUnactive("moveMegaMenu");
        ...
        this.options.wysiwyg?.emdadEditor.observerActive("moveMegaMenu");
    },
...
publicWidget.registry.HeaderGeneral = publicWidget.Widget.extend({
     ...
     */
    _onCollapseShow() {
        this.options.wysiwyg?.emdadEditor.observerUnactive("addCollapseClass");
        this.el.classList.add('o_top_menu_collapse_shown');
        this.options.wysiwyg?.emdadEditor.observerActive("addCollapseClass");
    },
    /**
     * @private
     */
    _onCollapseHidden() {
        this.options.wysiwyg?.emdadEditor.observerUnactive("removeCollapseClass");
        this.el.classList.remove('o_top_menu_collapse_shown');
        this.options.wysiwyg?.emdadEditor.observerActive("removeCollapseClass");
    },
    /**
     * @private
     */
