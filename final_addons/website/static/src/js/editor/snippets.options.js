...
import { Component, markup, useRef, useState } from "@emdad/owl";
...
options.registry.OptionsTab = options.Class.extend({
    ...
    async updateUI() {
        ...
        // If the gray palette has been generated by emdad standard option,
        ...
        // same hue by the emdad editor, there might be rounding errors
                ...
                this.trigger_up('menu_dialog', {
                    ...
                    save: (name, url) => {
                        ...
                        return this.orm.call(
                            ...
                            widget.wysiwyg.emdadEditor.observerUnactive();
                            widget.$target.attr('href', url);
                            $menu.text(name);
                            widget.wysiwyg.emdadEditor.observerActive();
                        });
                    },
                });
                widget.popover.hide();
...
options.registry.WebsiteAnimate = options.Class.extend({
    ...
    animationMode(previewMode, widgetValue, params) {
        ...
        if (widgetValue === "onHover") {
            ...
            this.options.wysiwyg.emdadEditor.historyPauseSteps();
            this.trigger_up("option_update", {
                optionName: "ImageTools",
