...
In order for your contribution to emdad to be accepted, you have to sign the
emdad Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [emdad/emdad](https://github.com/emdad/emdad), adding a new file
...
3. An emdad R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [emdad/emdad](/emdad/emdad), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is emdad, the file would be
    `doc/cla/corporate/emdad.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the emdad Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `emdad.com`.  In that case someone from the emdad team will
make the pull request on your behalf.

* Printable emdad CCLA v1.0 https://www.emdad.com/files/legal/emdad-CCLA-v1.0.pdf
* Printable emdad ICLA v1.0 https://www.emdad.com/files/legal/emdad-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for emdad is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the emdad project

* protect the emdad project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the emdad project and its users from bad actors who would contribute
...
contributor really intended to contribute to the emdad project under specific
...
The emdad CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, emdad S.A. to use, modify and
...
(ICLA) of emdad.  The agreement is executed by adding your name and
...
removed from the emdad project.
